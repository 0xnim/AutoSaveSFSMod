...
namespace AutoSave
{
    ...
    public class MyMod : Mod
    {
        ...
        public override string ModNameID => "autosave";

        public override string DisplayName => "AutoSaver";
        ...
        public override string Description => "Automatically creates a save file after set invertal.";
